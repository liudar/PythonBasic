    ...
    def sample_images(self, epoch):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i, j].axis('off')
                cnt += 1
        fig.savefig(r"C:\Users\liudr\Desktop\机器学习\李宏毅\hw6\save\%d.png" % epoch)
        plt.close()


# 读取extra_data中的图片，并保存
def load_data():
    image_dir = r'C:\Users\liudr\Desktop\机器学习\李宏毅\hw6\faces'
    image_size = 10000 #
    x_train = np.empty((image_size, 64, 64, 3), dtype="float32")
...
def main():
    ...
    # resize_function(r'C:\Users\liudr\Desktop\机器学习\李宏毅\hw6\faces\0.jpg','')
